...
async def get_main_menu_keyboard(lang_code: str) -> ReplyKeyboardMarkup:
    ...
    news_text = await text_service.get_text(
        'news_button', lang_code
        )
    courses_text = await text_service.get_text(
        'courses_button', lang_code
        )
    ...
    about_us_text = await text_service.get_text(
        'about_us_button', lang_code
        )
    faq_text = await text_service.get_text(
        'faq_button', lang_code
        )
